...
class Community:
    ...
    def get_graph(self, path, source, target, edge_attr):
        ...
        B = nx.from_pandas_edgelist(
            data, source=source, target=target, edge_attr=edge_attr
        )
    ...
    def plot_graph(self, G):
        ...
        nx.draw_networkx(
            G, pos, with_labels=False, node_size=30, font_size=5, node_color="red"
        )
    ...
    def get_modularity(self, G, o_deg_dict, m):
        ...
        print(
            "Number of communities after split: {}".format(
